                    ...
                    <form:form commandName="place">
                        <table>
                            ...
                            <tr>
                                ...
                                <%--<tr>--%>
                                <%--<th>--%>
                                <%--<div class="th"><fmt:message key="place.category"/><em class="must2">*<span--%>
                                <%--class="blind">필수</span></em></div>--%>
                                <%--</th>--%>
                                <%--<td>--%>
                                <%--<div class="td">--%>
                                <%--<input type="checkbox" name="category" value="SIGHTSEEING" ${SIGHTSEEING ? "checked" : ""}--%>
                                <%--class="ipt_check"--%>
                                <%--title=""><fmt:message--%>
                                <%--key="category.sightseeing"/>--%>
                                <%--<input type="checkbox" name="category" value="RESTAURANT" ${RESTAURANT ? "checked" : ""} class="ipt_check"--%>
                                <%--title=""><fmt:message--%>
                                <%--key="category.restaurant"/>--%>
                                <%--<input type="checkbox" name="category" value="HOTEL" ${HOTEL ? "checked" : ""} class="ipt_check"--%>
                                <%--title=""><fmt:message--%>
                                <%--key="category.hotel"/>--%>
                                <%--</div>--%>
                                <%--</td>--%>
                    ...
                    <c:forEach items="${languageList}" var="language" varStatus="status">
                        ...
                        <div id="contentsTable_${language}" style="display:${status.index == 0 ? "block" : "none"}">
                            <table>
                                ...
                                <tr>
                                    <th>
                                        <div class="th"><fmt:message key="place.searchKeyword"/>
                                        </div>
                                    </th>
                                    <td>
                                        <div class="td">
                                            <input type="text" name="searchKeyword_${language}" style="width:350px"
                                                   value="${contents != null ? contents.searchKeyword : ""}">

                                            <div class="yellow_box">
                                                <p class="yellow_mark"><fmt:message key="place.searchKeywordDesc"/></p>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                        <div class="th"><fmt:message key="place.mainTitle"/><em class="must2">*<span class="blind">필수</span></em>
                                        </div>
                                    </th>
                                    <td>
                                        <div class="td">
                                            <input type="text" name="mainTitle_${language}" style="width:350px"
                                                   value="${contents != null ? contents.mainTitle : ""}">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                        <div class="th"><fmt:message key="place.openTime"/><em class="must2">*<span class="blind">필수</span></em>
                                        </div>
                                    </th>
                                    <td>
                                        <div class="td">
                                            <input type="text" name="openTime_${language}" style="width:350px"
                                                   value="${contents != null ? contents.openTime : ""}">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                        <div class="th"><fmt:message key="place.priceStr"/><em class="must2">*<span class="blind">필수</span></em>
                                        </div>
                                    </th>
                                    <td>
                                        <div class="td">
                                            <input type="text" name="priceStr_${language}" style="width:350px"
                                                   value="${contents != null ? contents.priceStr : ""}">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
