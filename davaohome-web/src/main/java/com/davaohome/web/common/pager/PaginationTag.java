...
public class PaginationTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException {
		...
		try {
			...
			out.write("<div class=\"page_btn_wrap\">\n");
//			out.write("<a href=\"javascript:goPage('" + pagination.getFirstPage() + "')\" ><<</a>\n");
			out.write("<a href=\"javascript:goPage('" + pagination.getJumpPrevPage() + "')\" ><</a>\n");
			...
			out.write("<a href=\"javascript:goPage('" + pagination.getJumpNextPage() + "')\" >></a>\n");
//			out.write("<a href=\"javascript:goPage('" + pagination.getPageCount() + "')\" >>></a>\n");
			out.write("</div>\n");
